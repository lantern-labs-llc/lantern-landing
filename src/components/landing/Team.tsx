...
const team = [
  ...
  { name: "Rebecca Okafor", role: "Head of Partnerships", bio: "10 years helping SMBs grow. Knows Main Street inside and out. She's really just an AI construct.", initials: "RO" },
] as const;
