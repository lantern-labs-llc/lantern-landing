...
const steps = [{
  ...
  description: "When someone asks AI for recommendation in your area, your business is mentioned - positively and authentically."
}, {
  icon: DollarSign,
  step: "03",
...
const HowItWorks = () => <section id="how-it-works" className="section-padding relative overflow-hidden">
    <div className="max-w-7xl mx-auto">
      ...
      once: true
        ...
        <p className="text-muted-foreground text-lg">100% automatic. No tech headaches. Just more customers finding you.</p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
        ...
        delay: i * 0.15
            ...
            {i < steps.length - 1 && <div className="hidden md:block absolute top-12 left-[60%] w-[80%] border-t-2 border-dashed border-primary/20" />}
